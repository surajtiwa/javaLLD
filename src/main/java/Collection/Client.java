...
public class Client {
    public static void main(String[] args) {
       ...
       Comparator<Student> StudentPSPCompatator =new Comparator<Student>() {
           @Override
           public int compare(Student o1, Student o2) {
               return (int)(o1.psp-o2.psp);
           }
       };
        Comparator<Student> StudentPSPUnivNameComparator =(student,t1)->{
            if(student.psp < t1.psp) return -1;
            else if(t1.psp < student.psp) return 1;
            else{
                return student.univName.compareTo(t1.univName);
        }};
        Collections.sort(ls5,StudentPSPCompatator);
        Collections.sort(ls5,StudentPSPUnivNameComparator );
